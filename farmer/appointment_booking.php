      ...
      <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
          <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
              <form action="<?php echo "book_appointment.php?farmer=" . $_GET["farmer"]; ?>" method="POST" class="needs-validation" novalidate>
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="quantity" placeholder="Quantity to pick" name="quantity" min="1" required>
                  <span class="form-text text-danger"><small></small></span>
                </div>

                <div class="form-group">
                  <label for="p_date" class="text-secondary">Pickup date</label>
                  <input type="datetime-local" class="form-control" id="p_date" name="p_date" min="<?php echo date("Y-m-d H:i:s"); ?>" onkeydown="return false" required>
                  <span class="form-text text-danger"><small></small></span>
                </div>
