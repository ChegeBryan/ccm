    ...
    <div class="d-flex">
      ...
      <div class="container-fluid pt-9">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-secondary">Bookings' Awaiting Scheduling</h1>
        </div>
          ...
          <div class="col-lg-9">
            <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-dark">Unscheduled Farmers' Bookings</h6>
              </div>
                ...
                if ($stmt->execute()) {
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_array()) {
                      ...
                      echo "<td>" . date('M-d-Y H:i', strtotime($row['date_booked'])) . "</td>";
                      echo "<td>" . date('M-d-Y', strtotime($row['delivery_date'])) . "</td>";
                      echo "<td><a class='btn btn-secondary text-white btn-sm' href='approve_booking.php?book=" . $row['id'] . "'>Confirm</a></td>";
                    ...
                    echo "<p class='card-text'>No new Bookings made / unscheduled yet.</p>";
                  }
                }
              }
              $stmt->close();
