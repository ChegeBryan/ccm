    ...
    <div class="d-flex">
      ...
      <div class="container-fluid pt-9">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-secondary">Scheduled Appointments</h1>
        </div>
          ...
          <div class="col-lg-9">
            <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-dark">Scheduled Farmers' Appointments</h6>
                <a href="../reports/approved_appointments.php" class="btn btn-sm btn-secondary pull-right"
                   target="_blank" download><i class="fa fa-download fa-fw"></i>Generate
                  Report</a>
              </div>

              <div class="card-body">
                <?php
              $sql = "SELECT quantity, pick_date, confirmed_on, fullname, username, ccm_farm_inputs.farm_input  \n"
