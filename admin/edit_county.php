        ...
        <div class="col-xl-8 col-lg-7">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              ?>
              <!-- Card Body -->
              <form action=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?county=" . $_GET["county"]; ?> method="POST" class="needs-validation" novalidate>
                <div class="form-group <?php echo (!empty($county_err)) ? 'has-error' : ''; ?>">
                  <label for="county" class="text-secondary">County Name</label>
                  <input type="text" class="form-control" id="county" placeholder="County name" name="county" value="<?php echo $row['county']; ?>" required>
