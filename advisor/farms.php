...
<html lang="en">
  ...
  <head>
    <title>Farmers Land Information</title>
    ...
    <div class="d-flex">
      ...
      <div class="container-fluid pt-9">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          <h1 class="h3 mb-0 text-secondary">Farmers Land Utilization</h1>
        </div>
          ...
          <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Farmers lands</h6>
              </div>
                ...
                if ($stmt->execute()) {
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_array()) {
                      ...
                      echo "<td><a class='btn btn-primary btn-sm' href='farms.php?advisor=" . $_GET['advisor'] . "&farmer=" . $row['id'] . "'>View</a></td>";
                      echo "</tr>";
